...
def v75Condition(df):
    ...
    for current_candle in range(df_length-lookback, df_length):
        ...
        if (Engulfing(current_candle, close, open_, body_diff) == 1 and closeResistance(current_candle, resist_lvl, 1.0, df) == 1):  #DarkLine(row, close, open_, body_diff) == 1 or Harami(row, close, open_, body_diff) == 1 or
            if (df['Momentum'][current_candle] < 0 and df['MACD'][current_candle] < df['MACDsignal'][current_candle] or df['MACDsignal'][current_candle] < 0  or df['RSI'][current_candle] < 90 and df['RSI'][current_candle] > 50  ): # df['MACD'][row] < df['MACDsignal'][row] or df['MACDsignal'][row] <= 0 // df['RSI'][row] < 90 and df['RSI'][row] > 50  // \\ 
                signal[current_candle] = 1
        
        elif priceRejection(current_candle, open_, high, close, low, high_diff, body_diff, low_diff, h_ratio, lo_ratio) == 1 and closeResistance(current_candle, resist_lvl, 10.0, df) == 1:
        ...
        elif (DarkLine(current_candle, close, open_, low, high, body_diff) == 1 and closeResistance(current_candle, resist_lvl, 3.0, df) == 1):
            if (df['Momentum'][current_candle] < 0 and df['MACD'][current_candle] < df['MACDsignal'][current_candle] or  df['MACDsignal'][current_candle] < 0 or df['RSI'][current_candle] < 90 and df['RSI'][current_candle] > 50  ):  
                signal[current_candle] = 1
        ...
        # Buying signal     
            ...
            if (df['Momentum'][current_candle] > 0 and df['MACD'][current_candle] > df['MACDsignal'][current_candle] or df['MACDsignal'][current_candle] > 0 or df['RSI'][current_candle] < 50 and df['RSI'][current_candle] > 10 ): # df['MACD'][row] > df['MACDsignal'][row] or df['MACDsignal'][row] >= 0 //  df['RSI'][row] < 50 and df['RSI'][row] > 10 //\\ 
        ...
        elif (DarkLine(current_candle, close, open_, low, high, body_diff) == 2 and closeSupport(current_candle, sup_lvl, 3.0, df) == 2):
            if (df['Momentum'][current_candle] > 0 and df['MACD'][current_candle] > df['MACDsignal'][current_candle] or df['MACDsignal'][current_candle] > 0 or df['RSI'][current_candle] < 50 and df['RSI'][current_candle] > 10 ): 
                signal[current_candle] = 2
...
'''
    if (Engulfing(current_candle, close, open_, body_diff) == 1 and closeResistance(current_candle, resist_lvl, 1.0, df) == 1):  #DarkLine(row, close, open_, body_diff) == 1 or Harami(row, close, open_, body_diff) == 1 or
        ...
        elif (DarkLine(current_candle, close, open_, body_diff) == 1 and closeResistance(current_candle, resist_lvl, 1.0, df) == 1):
            if (df['Momentum'][current_candle] < 0 and df['MACD'][current_candle] < df['MACDsignal'][current_candle] or df['MACDsignal'][current_candle] < 0  or df['RSI'][current_candle] < 90 and df['RSI'][current_candle] > 50  ):  
                signal[current_candle] = 1
        ...
        elif (DarkLine(current_candle, close, open_, body_diff) == 2 and closeSupport(current_candle, sup_lvl, 5.0, df) == 2):
            if (df['Momentum'][current_candle] > 0 and df['MACD'][current_candle] > df['MACDsignal'][current_candle] or df['MACDsignal'][current_candle] > 0 or df['RSI'][current_candle] < 50 and df['RSI'][current_candle] > 10 ): 
                signal[current_candle] = 2
